...
// 同名 Counter 类的分趟版
class count_15to32_2 : public Counter {
public:
    count_15to32_2(kcoss::MultipleConcurrentBloomFilter *def_bloom_filter,
                   CompactFixedSizeHashMap<uint64_t, uint16_t> *hash_table_1,
...
private:
    ...
    CompactFixedSizeHashMap<uint64_t, uint16_t> *hash_table_1;//大表不扩容
